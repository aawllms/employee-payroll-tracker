...
const getRandomEmployee = function (employeesArray) {
  ...
  const employeeWinner = Math.floor(Math.random() * employeesArray.length);

  // Get the random employee from the array using the index
  const randomEmployee = employeesArray[employeeWinner];
